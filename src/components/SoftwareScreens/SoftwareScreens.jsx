...
export default function SoftwareScreens() {
  return (
    // Account screen
    <main className="flex flex-col items-center gap-24 overflow-hidden">
      <ScrollAnimation
      ...
      <ScrollAnimation
        ...
        <div className="flex items-center flex-row-reverse gap-10 mt-32 w-[70%] font-['Open_Sans'] text-2xl leading-[4rem] text-justify">
          ...
          />
          <p>
            A tela <strong>Minha Conta</strong> exibe informações essenciais
            sobre o usuário, incluindo seu <strong>Nome</strong>,{" "}
            <strong>CPF</strong>, <strong>Endereço de email</strong>,{" "}
