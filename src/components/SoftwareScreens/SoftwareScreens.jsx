...
export default function SoftwareScreens() {
  return (
    ...
    <main className="flex flex-col items-center gap-24">
      <div className="flex flex-wrap justify-center items-center gap-10 mt-32 w-[70%] font-main  leading-[3rem] text-justify">
        <img
          src={mainScreen}
          alt="Account screen"
          width={"500px"}
          className="shadow-xl"
        />
        <p className="max-w-[50%] max-2xl:max-w-[50rem] max-sm:text-center max-sm:text-lg max-sm:leading-[3rem]">
      ...
      <div className="flex flex-wrap justify-center items-center flex-row-reverse gap-10 mt-32 w-[70%] font-main  leading-[3rem] text-justify">
        <img
          src={accountScreen}
          alt="Account screen"
          width={"500px"}
